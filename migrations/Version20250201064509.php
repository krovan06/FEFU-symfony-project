 ...
 */
final class Version20250201064509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, price DOUBLE PRECISION NOT NULL, action VARCHAR(255) NOT NULL, portfolio_id INT NOT NULL, stock_id INT NOT NULL, INDEX IDX_A45BDDC1B96B5643 (portfolio_id), INDEX IDX_A45BDDC1DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
